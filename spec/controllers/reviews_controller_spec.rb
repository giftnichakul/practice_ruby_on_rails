...
RSpec.describe ReviewsController, type: :controller do
  ...
  describe 'PUT /update' do
    ...
    context 'when user sign in' do
      ...
      context 'when user update their own review' do
      ...
      context 'when user update other revuew' do
  ...
  describe 'DELETE /destroy' do
    ...
    context 'when user sign in' do
      ...
      context 'when user delete their oen review' do
        let!(:review) { create(:review, user: owner) }
        let(:params) do
          {
            id: review.id,
      ...
      context 'when user delete other review' do
        let(:other_user) { create(:user) }
        let!(:review) { create(:review, user: other_user) }
        let(:params) do
          {
